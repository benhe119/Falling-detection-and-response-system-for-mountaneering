#define GET_LOCATION_TRYING_TIME 10000 //in ms
void activateAirbag(){
...
/*DEMO: Instead of blinking LEDs, the buzzer is activated 5 seconds*/
...
void fallingReaction(){
   ...
   if (isLocationAvailable(GET_LOCATION_TRYING_TIME)){  //Location succesfully obtained
      ...
      while(!buttonsPressed()){
          ...
          if(isLocationAvailable(2000)){fallingReaction();};  //check GPS during 20 seconds
          Serial.println("failed");
          Serial.println("Activating brunzer 1 secs");
